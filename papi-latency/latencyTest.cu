...
main( int argc, char *argv[] )
{
   ...
   char *EventName[] = {"PERF_COUNT_HW_CPU_CYCLES","PERF_COUNT_HW_INSTRUCTIONS", "L1I_TLB_REFILL","L1D_TLB_REFILL","L2D_CACHE_REFILL","L1D_INVALIDATE","PERF_COUNT_SW_PAGE_FAULTS_MIN","DATA_MEM_ACCESS" };
